    ...
    <section class="news-section">
        ...
        <div class="news-container">
            ...
            <div class="news-card-border">
                <div class="news-card">
                    <img src="img/news 1.png" alt="Visiting Scientist Program" class="news-card-img">
            ...
            <div class="news-card-wrapper">
                <div class="news-card-border">
                    <div class="news-card">
                        ...
                        <div class="news-card-content">
                            <h3 class="news-card-title">Monthly Resesrch Discussion</h3>
                            <p class="news-card-description">
            ...
            <div class="news-card-border">
                <div class="news-card">
                    <img src="img/news 3.png" alt="International Research Discussion Program" class="news-card-img">
                    <div class="news-card-content">
        ...
        <div class="gallery-container">
            ...
            <div class="gallery-right">
                <div class="gallery-capsule mt-down">
                    <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=500&q=80" alt="Gallery 1">
                </div>
                <div class="gallery-capsule mt-up">
                    <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=500&q=80" alt="Gallery 2">
                </div>
                <div class="gallery-capsule mt-down">
                    <img src="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?auto=format&fit=crop&w=500&q=80" alt="Gallery 3">
                </div>
            </div>
        </div>
    </section>
